...
include('header.php');
    session_start();
            if(isset($_POST['submit'])){
                   ...
                   $sql="INSERT INTO CONTACTS (user_id,name , email, gender, languages,number,image, country,state,city, description,created_at)VALUES( '".$_SESSION['usr_id']."','$name','$email','$gender','$languages','$number','$target_file','$country','$state','$city','$description','$date')";
                   //exit;
            ...
            <div class="main-container">              
                <form  name="student" id="form" action="" method="POST" enctype="multipart/form-data">
                    <div>
                     ...
                     <!-- <input type="hidden" name="name"  value="<?php echo $_REQUEST['username'];?>"><br> -->
                   <div>
                       <label> Email:</label>
